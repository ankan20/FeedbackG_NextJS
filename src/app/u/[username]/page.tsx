...
const initialMessageString =
  "What's your favorite programming language?||Do you have any cool project?||What's your dream job?";
          ...
          <CardContent className="flex flex-col space-y-4">
            {suggestedMessages.map((message, index) => (
              <Button
                key={index}
                variant="outline"
                className="w-full py-2 px-4 mb-2 whitespace-normal text-center"
